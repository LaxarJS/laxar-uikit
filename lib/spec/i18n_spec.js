...
define( [
   ...
   '../moment_date_formats',
   '../number_formats'
], function( i18n, momentDateFormats, numberFormats ) {
   'use strict';
   ...
   describe( 'i18n.momentFormatForLanguageTag( languageTag )', function() {
      ...
      it( 'returns the format for a known language tag', function() {
         expect( i18n.momentFormatForLanguageTag( 'de' ) ).toEqual( momentDateFormats.de );
         expect( i18n.momentFormatForLanguageTag( 'fr' ) ).toEqual( momentDateFormats.fr );
      } );

      ////////////////////////////////////////////////////////////////////////////////////////////////////////

      it( 'returns US english format for an unknown language tag', function() {
         expect( i18n.momentFormatForLanguageTag( 'xxx' ) ).toEqual( momentDateFormats.en );
         expect( i18n.momentFormatForLanguageTag(  ) ).toEqual( momentDateFormats.en );
      } );
